...
Using Soan, [Clik Hire](https://github.com/MaartenGr/soan)
...
This project aims for analyzing whatsapp chat with natural language processing using python.
