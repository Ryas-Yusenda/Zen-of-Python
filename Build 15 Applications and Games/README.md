...
```
cd "Python Bootcamp 2021 Build 15 working Applications and Games"
```
...
This project aims for learn python with basics, data science, data visualisation, desktop graphical applications and python for web.
