...
```
pip install pandas, numpy, seaborn, matplotlib, wordcloud, plotly
```
...
This project aims for analyzing the US election with natural language processing with machine learning using python.
